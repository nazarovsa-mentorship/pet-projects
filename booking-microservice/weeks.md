...
# Неделя 1: Создание микросервиса
## Цель
...
# Неделя 2: Создание  API и абстракций бизнес-логики приложения
## Цель
...
# Неделя 3: Создание и тестирование бизнес-логики приложения
## Цель
...
```
3. Для взаимодействия с микросервисом "Каталог" при запуске приложения из IDE добавляем в appsettings.json секцию 
```json
	  "CatalogServiceOptions": {
		  "BasePath": "http://localhost:8000"
	  }
```
4. Для взаимодействия с микросервисом "Каталог" при запуске приложения в docker-compose добавляем в appsettings.Production.json секцию
```json 
	"CatalogServiceOptions": {
