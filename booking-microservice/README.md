...
- Для асинхронных взаимодействий используется Apache Kafka и библиотека Kafka Flow.
## Синхронный API
...
| Получить список отелей с ресурсами                                                                                        | GET     | Получает список отелей                                                                                                           | **bool**: *OnlyAvailableResources* - Фильтр только доступных ресурсов                                                                                                                    | **HotelData**: Информация об отеле:                                                                                     |
| Получить статус заявки на бронирование ресурса по распределенному идентификатору заявки | GET  | Получает статус заявки на бронирование по распределенному идентификатору заявки;                           | **Guid**: *RequestId* - распределенный идентификатор заявки;                                                        | **JobStatus**: *Status* - Статус заявки                                              |
## Модели данных
### HotelData
