...
Ты будешь использовать репозиторий для работы с агрегатом `BookingAggregate`. Репозиторий будет предоставлять методы для создания, получения и обновления бронирований.
